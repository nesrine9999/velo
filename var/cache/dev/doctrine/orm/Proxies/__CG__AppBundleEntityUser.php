...
class User extends \AppBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Cin', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'nom', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Prenom', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Sexe', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Date_naissance', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Num_tel', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Adresse', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Poste', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Civilite', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Pays', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Ville', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'Code_postal', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'photo', '' . "\0" . 'AppBundle\\Entity\\User' . "\0" . 'velo', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
